...
(dirctVars), key categorical variables (keyVars), key numerical variables
(numVars), key date-time variables (datetimeVars), sensitive variables
...
av <- anony.var(conf)
all.var <- c(av$dirv, av$all.vars) # all variables besides non-confidential data 
