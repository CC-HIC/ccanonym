...
The identifiable data set is usually stored in _ccRecord_ format, which is the default for CCHIC data. In the following code, we create the ccRecord object from an XML file which contains only five episodes.  
